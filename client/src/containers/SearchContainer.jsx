...
const SearchContainer = ({ setResponseResults }) => {
  return (
    <div id='searchContainer' className=' flex flex-col items-center w-lvw'>
      <div className='bg-black bg-opacity-80 p-6 rounded-lg shadow-lg max-w-5xl w-full mx-auto'>
